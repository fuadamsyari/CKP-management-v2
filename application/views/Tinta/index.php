										...
										<div class="card-body">
											<div class="row no-gutters align-items-center">
												<div class="col mr-2">
													...
													<div class="text-xs mb-0 font-weight-bold text-gray-600">Total Terjual : <?= number_format($bulan['total']['terjual'], 0, ',', ',') ?> </div>
													<div class="text-xs mb-0 font-weight-bold text-gray-600">Total Modal : <?= number_format($bulan['total']['modal'], 0, ',', ',') ?></div>
													<div class="text-xs mb-0 font-weight-bold text-gray-600">Total Laba : <?= number_format($bulan['total']['untung'], 0, ',', ',') ?></div>
												</div>
												<div class="col-auto">
